...
- including a section on [list columns](https://jennybc.github.io/purrr-tutorial/ls13_list-columns.html), i.e. a column within a dataframe that contains a general vector, that is a list of values, as opposed to an atomic vector.
